...
U = {U1, U2, U3, U4};
X = ttm(S, U, [1:4]);
n = floor(p^(2)/(lambda_min^2) * 3); % rescale
A = randn(n, p1)/n;
...
RGD_error_matrix = RGD_tensor_vector_regression(A,Y,Xt, Ut,X, U, p1, p2, p3, p4,r1_use,r2_use,r3_use,r4_use, t_max, succ_tol);
array2table(RGD_error_matrix)
