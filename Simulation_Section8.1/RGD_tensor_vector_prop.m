...
for ratio = ratio_candidate
    for sig = sig_total
        ...
        Ut = init_result.u;
        RGD_error = RGD_tensor_vector(A,Y,Xt, Ut,X, U, p1, p2, p3, p4,r1_use,r2_use,r3_use,r4_use, t_max, succ_tol);
        nrow_error = size(RGD_error,1);
        RGD_error = horzcat( RGD_error, repelem( ratio, nrow_error )', repelem( sig, nrow_error )' );
        final_result = vertcat(final_result, RGD_error);
    end
end
toc
