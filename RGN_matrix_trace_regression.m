% Riemannian Gauss-Newton for Matrix trace regression
...
function [error_matrix,succ_tag] = RGN_matrix_trace_regression(A, y, r, p1, p2, hatX,X, iter_max, tol, succ_tol, retra_type)
    A1 = tenmat(A,1);
    [U0,~,V0] = svds(hatX,r);
    Ut = U0;
    Ut_perp = null(Ut');
